...
# read the contents of zvvs1.txt and zvvs2.txt and store the user IDs in separate lists
...
def handle_send(message):
    # check if the sender's ID is in the list of admins
    ...
    # send the message to all users in zvvs1_users and zvvs2_users
